...
Ši sistema turi didžiausią priklausomybių registrą pasaulyje, ja naudojantis galima atsisiųsti paketus arba Node modulius.\textsuperscript{[NPMa]}.

\input{\SRCPATH/2-content/content-2.1}

\input{\SRCPATH/2-content/content-2.2}

\section{Maven priklausomybių valdymo sistema}

Apache Maven yra daugiausiai Java projektams naudojama priklausomybių valdymo sistema \textsuperscript{[MAVENa]}.
...
koordinatėmis \textsuperscript{[MAVENb]}. Maven Central repozitorija yra numatytoji vieta ieškoti
priklausomybėms, tačiau pom.xml galima pridėti ir kitų repozitorijų (pavyzdžiui,
kompanijų privačias repozitorijas), iš kurių bus siunčiamos priklausomybės \textsuperscript{[MAVENc]}.
...
iš tėvinio modulio \textsuperscript{[MAVENb]}. Tai palengvina pom.xml failų palaikymą.

\input{\SRCPATH/2-content/content-3.1}
